...
import { AppStore, MusicStore } from '../../../stores';
...
const Spotify: React.FC = () => {
    ...
    useEffect(() => {
        const handleSongData = async (data: SongData) => {
            if (data.thumbnail) {
        ...
        const removeListener = musicStore.subscribeToSongDataUpdate(handleSongData);
