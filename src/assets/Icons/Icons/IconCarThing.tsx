...
function IconCarThing(props): JSX.Element {
  ...
  return <Icon {...props} strokeWidth={props.strokeWidth || 20}> <svg
...
>
  ...
  <g>
      ...
      <text x="480" y={props.fontSize * 0.2 + 350 || '350'} fill="white" fontSize={props.fontSize || 100} textAnchor="middle">{props.text || ''}</text>
  </g>
</svg></Icon>
}
