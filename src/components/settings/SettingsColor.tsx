...
import { SettingsColor } from '../../types/settings';
...
export const SettingsColorComponent: React.FC<SettingsColorProps> = ({ handleSettingChange, className, setting }) => {
    ...
    <SettingComponent setting={setting} className={className}>
                <div className="max-w-[100px] relative flex justify-end items-center">
                  ...
                  <div className="relative">
                    ...
                    />
                    {showPrompt && (
                        <div onClick={() => setShowPrompt(false)} className="fixed top-4 left-4 z-50 flex items-center rounded-lg bg-green-500 px-4 py-2 text-sm text-white">
