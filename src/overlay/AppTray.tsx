...
const AppTray: React.FC = () => {
    ...
    return (
    <div className={`w-screen flex flex-col absolute top-0 ${appTrayState == ViewMode.FULL ? 'bg-zinc-900 transition-colors' : 'bg-zinc-950'} transition-[height] z-10 ${height}`}>
            <div>
